...
const ChatWidget = ({ hasPackage = true }) => {
  ...
  return (
    <div>
      {!open && (
        <button
          className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-gradient-to-br from-indigo-500 to-blue-600 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-all duration-200 border-4 border-white"
          onClick={handleOpen}
